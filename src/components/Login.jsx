      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box">
          <form onSubmit={handleSubmit(onSubmit)} method="dialog">
            ...
            <Link
              to="/"
              className="btn btn-sm text-black btn-circle btn-ghost absolute right-2 top-2"
            ...
            <div className="flex justify-around mt-6">
              <button className="bg-stone-500 text-white rounded-md px-3 py-1 hover:bg-black duration-200">
                Login
              </button>
              <p>
                Not registered?{" "}
